...
autocmd FileType c,cpp,cc  set cindent comments=sr:/*,mb:*,el:*/,:// cino=>s,e0,n0,f0,0{,{0,}0,^-1s,:0,=s,g0,h1s,p2,t0,+2,(2,)20,*30 fdm=marker fmr={,}
...
set fileencodings=ucs-bom,utf-8,cp936,gb2312,gb18030,big5,latin1
...
"Mark for unknown (lsj 2013 05 30)
...
map <leader><F3> : !ctags -R --c++-kinds=+p --fields=+iaS --extra=+q .<CR>
